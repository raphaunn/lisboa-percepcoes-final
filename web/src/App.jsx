...
function Consent({ onOk, setPid, testMode }) {
  ...
  return (
    <div>
      ...
      <p>Esse projeto é realizado em contexto acadêmico, em âmbito do Mestrado de Ciências e Sistemas de Informação Geográfica, pela NOVA IMS. O repositório do projeto, juntamente a referências e informações adicionais encontram-se em: <strong>github.com/raphaunn/lisboa-percepcoes-final.</strong>strong></p>
